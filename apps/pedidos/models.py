...
class Pedido(models.Model):
    ...
    cantidad_adiciones = models.PositiveIntegerField(
        default=0,
...
class PedidoConfirmacion(models.Model):
    """Registra cada confirmación del carrito para impedir adiciones duplicadas."""

    pedido = models.ForeignKey(
        Pedido, on_delete=models.CASCADE, related_name="confirmaciones"
    )
    ...
    def __str__(self):
        return f"Confirmación de pedido #{self.pedido_id}"
