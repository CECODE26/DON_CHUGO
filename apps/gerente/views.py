...
def reporte_exportar(request):
    ...
    if fmt == "pdf":
        ...
        filename = f"reporte-don-chugo-{desde}-{hasta}.pdf"
    ...
    try:
        ...
        return redirect("gerente:reportes")
    from django.http import HttpResponse
    filename = f"reporte-don-chugo-{desde}-{hasta}.xlsx"
    resp = HttpResponse(
        xlsx_bytes,
...
def configuracion(request):
    ...
    return render(request, "gerente/configuracion.html", {
        ...
        "restaurante_nombre":    _cfg("restaurante_nombre",    "Don Chugo"),
...
def reportes_exportar_custom(request):
    ...
    resp["Content-Disposition"] = f'attachment; filename="reporte-don-chugo-{desde}-{hasta}.{ext}"'
    return resp
