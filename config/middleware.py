    ...
    def __call__(self, request):
        ...
        if role:
            if role in request.COOKIES:
                ...
                # Si todavía no existe cookie propia del módulo, aceptar como
                # respaldo la sesión genérica. Esto permite que un administrador
                # autenticado en /admin/ abra Caja, Mesero o Gerente sin caer en
                # un ciclo /accounts/login/ ↔ /gerente/. En cuanto el módulo
                # tenga su cookie sid_* seguirá prevaleciendo y mantendrá el
                # aislamiento entre terminales de mesero y cocina.
                pass
