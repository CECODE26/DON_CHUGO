...
from config.admin_views import reporte_caja_diario
from config.admin_customization import customize_admin
from apps.mesas.api import get_mesa_qr

# Garantiza que el menú personalizado también se registre al cargar el URLConf
# (runserver, tests y otros servidores además de WSGI/Gunicorn).
customize_admin()
...
urlpatterns = [
    ...
    path("admin/caja/reporte-diario/", reporte_caja_diario, name="admin_reporte_caja_diario"),
    path("admin/", admin.site.urls),
    path("accounts/", include("apps.accounts.urls")),
    path("api/mesas/<int:mesa_id>/qr/", get_mesa_qr, name="api_mesa_qr"),
